		   ...
		   <div class="container">
				<div class="row"> 
                    <div class="col-sm-6 col-md-4 logo">
                        <a href="index.html" title="Cp mercury">
                            <img class="light" src="logo-3.png"  width="120" alt="Cp mercury">
                            <img class="dark" src="logo-1.png"  width="120" alt="Cp mercury">
                        </a>
                    </div>
                ...
                <div class="container">
                    <div class="row align-items-center flex-row-reverse">
                        ...
                        <div class="col-sm-12 col-md-6">
                            <h1>Golden trade makes it safe and easy to invest </h1>
                            ...
                            <div class="token-allocation-animation">
                                <div class="main-circle-one">
                                    ...
                                    <div class="center-point">
                                        <img src="images/gold-animation-icon-1.png" alt="" >
                                    </div>
                                </div>
                            </div>
                        </div>
