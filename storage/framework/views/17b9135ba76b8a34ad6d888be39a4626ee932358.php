										...
										<tr> 
											...
											<td>
												...
												<div class="dropdown-menu bg-<?php echo e(Auth('admin')->User()->dashboard_style); ?>" aria-labelledby="dropdownMenuLink">
													...
													<?php endif; ?>
													<?php if($list->allow_withdrawal=='on'): ?>
													<a class="btn btn-danger btn-sm m-1" href="<?php echo e(url('admin/dashboard/userwithdrawalmode')); ?>/<?php echo e($list->id); ?>/off">Disable withdrawal</a> 
													<?php else: ?>
													<a class="btn btn-success btn-sm m-1" href="<?php echo e(url('admin/dashboard/userwithdrawalmode')); ?>/<?php echo e($list->id); ?>/on">Enable withdrawal</a>
													<?php endif; ?>
